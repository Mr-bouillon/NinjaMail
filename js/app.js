    ...
    (() => {
        ...
        window.addEventListener("scroll", (() => {
            ...
            if (scrollDistance < lastScrollTop && scrollDistance > headerHeight) {
                ...
                header.style.top = "0";
            } else if (scrollDistance > lastScrollTop && scrollDistance > headerHeight) header.style.top = "-100%";
            if (0 === scrollDistance) {
                header.style.top = "0";
        ...
        var myCol = document.getElementsByClassName("hero-section__button");
        ...
        function setActive(e) {
            ...
            var i;
            for (i = 0; i < myCol.length; i++) myCol[i].classList.remove("hero-section__button-active");
            target.classList.toggle("hero-section__button-active");
        }
        var j;
        for (j = 0; j < myCol.length; j++) myCol[j].addEventListener("mouseover", (function(e) {
            setActive(e);
        }), false);
        window["FLS"] = true;
        isWebp();
